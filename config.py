...
# Parameters
C_D = [1]
D_ij = [[0, 1, 1, 3], [1, 0, 2, 2], [1, 2, 0, 2],  [3, 1, 2, 0]]  # in kms
C_R = 10
C_F = 1
C_T = 1
Q_S = [10]
Q_W = [1]
L_S = [1, 2] #Load for each request
L_W = [0, 1] #Wheelchair load for request
T_ij = [
    [timedelta(hours=0, minutes=0), timedelta(hours=0, minutes=7), timedelta(hours=0, minutes=5), timedelta(hours=0, minutes=7)],
    [timedelta(hours=0, minutes=7), timedelta(hours=0, minutes=0), timedelta(hours=0, minutes=5), timedelta(hours=0, minutes=5)],
    [timedelta(hours=0, minutes=5), timedelta(hours=0, minutes=5), timedelta(hours=0, minutes=0), timedelta(hours=0, minutes=6)],
    [timedelta(hours=0, minutes=7), timedelta(hours=0, minutes=5), timedelta(hours=0, minutes=6), timedelta(hours=0, minutes=0)]
]
